...
**Meeting Transcribe Agent** 是一套以 **Google Gemini 3.5 Transcribe** 為核心、具備「全雲端極速」與「本地離線隱私」雙引擎架構的高精度多語者會議轉譯與智慧會議記錄 Agent。專為公務市政主管會議、跨國技術週會、法務訪談存證以及隔離網閘（Air-Gapped）等高度要求「時間戳精準度」、「發言人切分」與「結構化決策記錄」的專業場景所打造。
