...
**Meeting Transcribe Agent** 是一套結合 **Google Gemini 3.5 Transcribe**（專用聲學語音辨識）與 **Gemini Flash**（智慧語意結構重構）雙核心架構的高精度多語者會議轉譯與智慧會議記錄 Agent。專為公務市政主管會議、跨國技術週會以及訪談法務存證等高度要求「時間戳絕對精準」、「發言人切分」與「結構化決策記錄」的專業場景所打造。
